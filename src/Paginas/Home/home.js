...
import { Section, H5Titulo, TituloH1Grid, ImgSection, DivCardGrid, DivFundo, SectionContador, H4Section, PSection,ImagemDeFundo } from "./styled";
...
export const Home = () =>{
    ...
    useEffect(() => {
        ...
        if (target) {
          const unobserve = InView.observe(target, handleIntersect, {
            root: null,
            threshold: 0,
          });
